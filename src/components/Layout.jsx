...
const Layout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#FBF8EF]">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 w-64 h-screen bg-gray-200 text-gray-900 flex flex-col transform transition-transform duration-300 ease-in-out z-40 pt-16 md:pt-0 overflow-y-auto ${
